 ...
 */
class ActorHitPointsConfig extends DocumentSheet {
  constructor(...args) {
    super(...args);
 ...
 */
class ActorInitiativeConfig extends DocumentSheet {
 ...
 */
let TraitSelector$1 = class TraitSelector extends DocumentSheet {
